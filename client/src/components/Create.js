                ...
                <div className="container">
                    <div className="panel panel-default">
                        ...
                        <div className="panel-body">
                            ...
                            <form onSubmit={e => {
                                e.preventDefault();
                                addBook({ variables: { title: title.value, author: author.value, description: description.value, publisher: publisher.value, published_year: parseInt(published_year.value) } });
                                title.value = "";
                                author.value = "";
                                description.value = "";
